...
def get_args():
    ...
    parser.add_argument('--num-dice', type=int, default=1, help='number of dice to train with')
    parser.add_argument('--include-dice-velocity', type=int, default=0, help='whether to include dice velocities in observations') # 1=True, 0=False
    parser.add_argument('--include-dice-orient', type=int, default=0, help='whether to include dice orientation in observations') # 1=True, 0=False
    ...
    parser.add_argument('--seperate-her', type=int, default=1, help='whether to apply HER individually to each dice goal')
    parser.add_argument('--scale-dice', type=float, default=1, help='scale size of the dice')
    parser.add_argument('--single-dice-focus', type=int, default=1, help='whether to focus only on a single dice')
    parser.add_argument('--single-goal-focus', type=int, default=1, help='whether to focus only on a single goal')
    parser.add_argument('--increment-dice', type=int, default=4, help='periodically increase the number of dice by this amount')
    parser.add_argument('--increment-freq', type=int, default=50, help='epoch frequency to increment number of dice')
    parser.add_argument('--update-wait', type=int, default=5, help='epochs to collect data without update after incrementing num dice')
    parser.add_argument('--max-dice', type=int, default=9, help='max num dice to increment to')
    parser.add_argument('--domain-randomization', type=int, default=1, help='whether to use domain randomisation')
